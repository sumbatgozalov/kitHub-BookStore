...
@section('mainContent')
<section class="contact-box-main ">
            ...
            <div class="col-lg-4 col-sm-12 ">
                <div class="contact-info-left ">
                    ...
                    <p>When it comes to searching for books, there is only one place to turn to – Book Hub.We have a veritable collection of books that span categories as diverse as you could possibly expect. From segments like accountancy, to parenting
                        and pregnancy, to banking and finance, to even topics on yoga and meditation – almost any category you seek – you will find with us</p>
                    <ul>
                        <li>
                        ...
                        <li>
                            <p><i class="fas fa-envelope "></i>Email: <a href="mailto:bookhubinfo@gmail.com ">bookhub2020@gmail.com</a></p>
                        </li>
                    </ul>
                </div>
            </div>
