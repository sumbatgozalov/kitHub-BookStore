<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="{{ route('redirect') }}"><img
                src="{{ asset('admin/assets/images/logo.svg') }}" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="{{ route('redirect') }}"><img
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('view_language') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-playlist-play"></i>
                </span>
        ...
        <li class="nav-item menu-items">
            ...
            <ul class="nav flex-column sub-menu " >
              ...
              <li class="nav-item"> <a class="nav-link" href="{{route('view_products')}}">Add Product</a></li>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('view_charts')}}">
                <span class="menu-icon" >
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('view_icons')}}" >
                <span class="menu-icon">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="#"> Blank Page </a>
                    </li>
